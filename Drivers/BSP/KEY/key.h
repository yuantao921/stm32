...
#define WKUP_GPIO_PIN                   GPIO_PIN_15
#define WKUP_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */

#define KEY3_GPIO_PORT                  GPIOA
#define KEY3_GPIO_PIN                   GPIO_PIN_15
#define KEY3_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能（与WKUP共用） */

#define KEY4_GPIO_PORT                  GPIOA
#define KEY4_GPIO_PIN                   GPIO_PIN_5
#define KEY4_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */
...
#define WK_UP       HAL_GPIO_ReadPin(WKUP_GPIO_PORT, WKUP_GPIO_PIN)     /* 读取WKUP引脚（KEY3） */
#define KEY3        HAL_GPIO_ReadPin(KEY3_GPIO_PORT, KEY3_GPIO_PIN)     /* 读取KEY3引脚（与WKUP共用） */
...
#define WKUP_PRES    4              /* KEY_UP按下(即WK_UP/KEY3) */
#define KEY3_PRES    4              /* KEY3按下（与WKUP共用） */
